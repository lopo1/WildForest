<template>
	...
	<view class="delete-popup" v-show="show">
		<view class="get-box" :class="{deleteActive:type == 1}">
			<view class="get">
				<image class="get-icon" src="/static/get/icon.png" mode=""></image>
				<text class="get-txt">恭喜你抽中大奖</text>
			</view>
			<view class="get-icon-box">
				<image class="get-icon2" src="@/static/index/icon5.png" mode=""></image>
				<text class="get-icon-txt">x31</text>
			</view>
			<view class="get-btn" @tap='onClose'>
				<text class="get-btn-txt">立即领取</text>
			</view>
		</view>
	</view>
</template>
